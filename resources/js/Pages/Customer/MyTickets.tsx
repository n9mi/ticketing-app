...
const MyTickets = ({ response, params } : { response: MyTicketsResponse, params : MyTicketsParams  }) => {
    ...
    const handleFilter = (
        ...
        router.get(route("customer.my-tickets"),
            {
                subject : subject,
                                ...
                                <TableRow key={ i }>
                                    ...
                                    <TableCell>
                                        <Button className="w-1/4">
                                            <Link href={ route("customer.edit-ticket", d.id) }>
                                                <Edit />
                                            </Link>
                                        </Button>
                                    </TableCell>
...
MyTickets.layout = (page : ReactNode) =>
    <MasterLayout title={ "My Tickets" } children={ page } />
